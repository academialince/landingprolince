...
/**
 * Botón flotante de contacto. No se renderiza si no hay número configurado: antes ningún
 * WhatsApp que uno que lleve a un desconocido.
 */
export function BotonWhatsapp() {
  ...
  return (
    <a
      ...
      className="group fixed bottom-5 right-5 z-50 inline-flex items-center gap-3 rounded-full bg-[#25D366] pl-4 pr-5 py-3.5 text-white font-bold shadow-[0_10px_30px_rgba(37,211,102,0.35)] transition-transform duration-200 ease-[var(--ease-product)] hover:-translate-y-0.5 focus-visible:-translate-y-0.5"
    >
      ...
      <span className="hidden sm:inline whitespace-nowrap">¿Hablamos por WhatsApp?</span>
      <span className="sr-only sm:hidden">¿Hablamos por WhatsApp?</span>
    </a>
  );
}
